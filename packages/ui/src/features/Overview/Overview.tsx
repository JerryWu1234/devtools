  ...
  return (
    <>
      <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
        <div class="flex items-center gap-5 rounded-xl border border-[var(--color-border-translucent)] bg-[var(--color-card-item-bg)] p-5 transition-all duration-200 hover:-translate-y-0.5 hover:bg-[var(--color-card-item-hover-bg)]">
          <div class="rounded-lg border border-[var(--color-border-translucent)] bg-foreground bg-opacity-5 p-3.5">
      ...
      <div class="space-y-4 rounded-xl border border-[var(--color-border-translucent)] bg-[var(--color-card-item-bg)] p-5">
        <h3 class="text-lg font-semibold">Installed Packages</h3>
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
          {state.npmPackages.map(([name, version]) => (
            <div
              key={name}
              class="flex items-center justify-between rounded-lg bg-foreground bg-opacity-5 p-3"
            >
      ...
      <div class="space-y-4 rounded-xl border border-[var(--color-border-translucent)] bg-[var(--color-card-item-bg)] p-5">
        ...
        <div class="space-y-3">
          <div class="flex justify-between border-b border-b-[var(--color-border-translucent)] py-2">
